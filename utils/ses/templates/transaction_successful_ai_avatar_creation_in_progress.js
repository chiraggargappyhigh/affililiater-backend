              ...
              <body>
                <div class="main">
                  ...
                  <main class="body">
                    ...
                    <p class="text">AI Avatar Creation in Progress</p>
                    <div class="avatar">
                      <img src="https://i.ibb.co/fChVdX6/Group-1000004495.png" alt="avatar" />
                    </div>
                    <p class="text text1">
                      We are pleased to inform you that your transaction to create AI avatars has been successful. Our team has
                      started working on your avatars, and we will deliver them to you soon.
                    </p>
                    <p class="text">Thank you for choosing AI Avatar Maker for your avatar creation needs.</p>
                    <p class="text">
                      If you have any questions or concerns, please reply to this email!<br />
                      We are happy to help you!
                    </p>
                    <button class="statusbtn">Check Status</button>
                    <hr class="rule" />
                  </main>
                  <footer>
                    <p class="footer">
